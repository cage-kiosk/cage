...
main(int argc, char *argv[])
{
	...
	wl_signal_add(&server.input_method_manager_v2->events.new_input_method, &server.new_input_method);
	...
	wl_signal_add(&server.text_input_manager_v3->events.new_text_input, &server.new_text_input);
